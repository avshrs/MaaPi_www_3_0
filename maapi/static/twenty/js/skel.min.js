var skel = function() {
  var e = "config",
    ...
    Z = "DOMContentLoaded",
    et = "string",
    tt = "getDevicePixelRatio",
    nt = ".row",
    rt = "_skel_attach",
    it = "states",
    st = "matchMedia",
    ot = "IEVersion",
    ut = "ignoreOrientation",
    at = "placeholder",
    ...
    Ft = {
      ...
      extend: function(e, t) {
        var n;
        Ft[r](t, function(n) {
          Ft[D](t[n]) ? (Ft[D](e[n]) || (e[n] = []), Ft[O](e[n], t[n])) : typeof t[n] == E ? (typeof e[n] != E && (e[n] = {}), Ft[O](e[n], t[n])) : e[n] = t[n]
        })
      },
      parseMeasurement: function(e) {
        var t, n;
        if (typeof e !== et) t = [e, "px"];
      ...
      getViewportWidth: function() {
        var t, n, r;
        return t = document[ct].clientWidth, n = window.orientation !== undefined ? Math.abs(window.orientation) : u, r = Ft[tt](), screen.width < t && (t = screen.width), n !== u && (Ft[e][ut] ? t = Math.min(screen.width, screen.height) : n === 90 ? t = Math.max(screen.width, screen.height) : t = Math.min(screen.width, screen.height)), t /= r, t
      },
      unlock: function() {
        Ft[S] = p, document.cookie = Ft.lsc + "=;expires=Thu, 1 Jan 1970 12:00:00 UTC; path=" + (Ft[e].domainLock ? "/" : window[j].pathname), Ft[e].pollOnLock ? Ft.poll() : window[j].reload()
      },
      lock: function(t) {
        Ft[S] = t, document.cookie = Ft.lsc + "=" + t + ";expires=" + (Ft[e].perpetualLock ? "Thu, 1 Jan 2077 12:00:00 UTC" : 0) + "; path=" + (Ft[e].domainLock ? "/" : window[j].pathname), Ft[e].pollOnLock ? Ft.poll() : window[j].reload()
      },
      getLock: function() {
        return Ft[S]
      },
      ...
      attachElement: function(e) {
        var t, n = e[j],
          r = u;
        return e[ht] ? _ : (n[0] == "^" && (n = n[J](1), r = _), n in Ft[L] ? (t = Ft[L][n], t[rt](e[E], r), e[ht] = _, e.onAttach && e.onAttach(), _) : u)
      },
      ...
      poll: function() {
        ...
        }), i === "" && (i = Ft.sd), i !== Ft[s] && (Ft[L][Mt][A] = Ft[L][Mt][A][F](Ft[s], ""), Ft.changeState(i), Ft[L][Mt][A] = Ft[L][Mt][A] + Ft[s])
      },
      ...
      changeState: function(c) {
        ...
        if (!Ft[g][it][Ft[s]]) {
          Ft[g][it][Ft[s]] = {
            ...
            elements: [],
            values: {}
          }, b = Ft[g][it][Ft[s]], Ft[s] === Ft.sd ? h = [] : h = Ft[s][J](1).split(Ft.sd), Ft[O](b[e], Ft[V][v]), Ft[r](h, function(t) {
            Ft[O](b[e], Ft[n][h[t]][e])
          });
          switch (Ft[e].reset) {
            case "full":
          ...
          Ft[r](h, function(s) {
            Ft[n][h[s]][e][yt] && (C = "ss" + h[s], (S = Ft[i](C)) || (S = Ft[f](C, Ft.newStyleSheet(Ft[n][h[s]][e][yt]), T, 5)), b[t][R](S)), Ft[n][h[s]][t][l] > 0 && Ft[r](Ft[n][h[s]][t], function(e) {
              b[t][R](Ft[n][h[s]][t][e])
            })
          }), Ft[g][a][Ft[s]] && (Ft[r](Ft[g][a][Ft[s]], function(e) {
            b[t][R](Ft[g][a][Ft[s]][e])
        ...
        Ft.detachAllElements(b[t]), Ft[Lt](b[t]), Ft[q](function() {
          ...
          Ft[e].RTL && (Ft.unreverseRows(), s > 0 && Ft.reverseRows(s)), Ft[x][ot] > 8 && (n = "_skel_cell_important_placeholder", t = Ft[o]("skel-cell-important"), t && t[l] > 0 && Ft[r](t, function(e) {
            if (e === l) return;
            var r = t[e],
              i = r[m],
              o;
      ...
      newInline: function(e) {
        var t;
        return Ft[x][ot] <= 8 ? (t = document[C]("span"), t[Nt] = '&nbsp;<style type="text/css">' + e + "</style>") : (t = document[C]("style"), t.type = Ot, t[Nt] = e), t
      },
      newDiv: function(e) {
      ...
      initConfig: function(i) {
        function a(e, t) {
          ...
          return typeof t != et && (n = function(e) {
            ...
            return t >= s[e]
          }) : Ft[P](t, "-") != -1 ? (t = t.split("-"), s[e] = [parseInt(t[0]), parseInt(t[1])], n = function(t) {
        ...
        var s = [],
          o = [];
        typeof i == E && (i[n] && (Ft[e][n] = {}), Ft[O](Ft[e], i)), Ft[O](Ft[V][v].grid, Ft[e].grid), Ft[V][v][N] = Ft[e][N], Ft[r](Ft[e][n], function(r) {
          var i, s = {};
          Ft[O](s, Ft[e][n][r]), yt in s || (s[yt] = Ft[V][v][yt]), "range" in s || (s.range = Ft[V][v].range), Ft[e][n][r] = s, i = {}, Ft[O](i, Ft[V].breakpoint), i[e] = Ft[e][n][r], i.test = a(r, i[e].range), i[t] = [], Ft[e].prefix && i[e][yt] !== u && (i[e][yt] = Ft[e].prefix + "-" + r + ".css"), i[e][yt] === "" && (i[e][yt] = u), Ft[e].preload && i[e][yt] && o[R](i[e][yt]), Ft[n][r] = i, Ft.breakpointList[R](r)
        }), Ft[r](Ft[e][$], function(t) {
          Ft.bind(t, Ft[e][$][t])
        }), o[l] > 0 && window[j].protocol != "file:" && Ft[q](function() {
          var e, t = document[c](T)[0],
      ...
      initAPI: function() {
        ...
        Ft[x][ot] = n[d](/MSIE ([0-9]+)\./) ? RegExp.$1 : 99, e = "other", n[d](/Firefox/) ? e = "firefox" : n[d](/Chrome/) ? e = "chrome" : n[d](/Safari/) && !n[d](/Chrome/) ? e = "safari" : n[d](/(OPR|Opera)/) ? e = "opera" : n[d](/MSIE/) && (e = "ie"), Ft[x].browser = e, Ft[x][h] = "other", t = {
        ...
        Ft[x].deviceVersion = e, Ft[x].isTouch = Ft[x][h] == "wp" ? navigator.msMaxTouchPoints > 0 : "ontouchstart" in window, e = document.cookie.split(";"), Ft[r](e, function(t) {
          var n = e[t].split("=");
      ...
      init: function(e, t) {
        Ft.initUtilityMethods(), Ft.initAPI(), Ft.initConfig(e), Ft[X](Mt, document[c](Mt)[0]), Ft[X](T, document[c](T)[0]), Ft[q](function() {
