...
class MaaPiExecMath_exec(object):
    ...
    def run_math_expressions(self,math_id,force_e,force_v):
        ...
        if self.device_table[int(self.math_table[math_id]["math_update_rom_id"])]["dev_type_id"] == self.maapi_math_id:
            ...
            qa ("insert")
            self.db_con.insert_data(self.math_table[math_id]["math_update_rom_id"],value,self.device_type,True)
            qa("inserting data")
    ...
    def __init__(self):
        ...
        self.math_table = self.db_con.select_table("maapi_math","id","asc","math_enabled",True)

        """ GET MAAPI_DEVICE_LIST TABLE """
        maapi_device_list = self.db_con.select_table("maapi_device_list",None,None,None,None)

        """ GET DEVICES TABLE """
        self.device_table=self.db_con.select_table("devices",None,None,None, None)
        ...
        for math in self.math_table:
            ...
            if self.math_table[math]["math_enabled"]:
