...
class DevicesAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
                ('Main device parameters', {'fields': ['dev_user_id',
                                                       'dev_tag_name',
                                                       'dev_user_name',
                                                       'dev_user_describe',
                                                       'dev_rom_id',
                ...
                ('Bus and type parameters', {'fields': ['dev_type',
                                                        'dev_bus_type',
                                                        'dev_bus_options',
                                                        'dev_gpio_pin',
                                                        'dev_hidden',
                ...
                ('Device - value info ', {'fields': ['dev_value',
                                                     'dev_unit',
                                                     'dev_adjust',
                                                     'dev_value_old',
                                                     'dev_last_update',
                ...
                ('Location and Groups', {'fields': ['dev_location',
                                                    'dev_main_group',
                                                    'dev_sec_group',
                                                    'dev_third_group',
                                                    ]
...
class MailWachDogAdmin(admin.ModelAdmin):
    list_display = ['mail_user_id',
                    'mail_name',
                    'mail_condition_min_e',
                    'mail_condition_max_e',
                    'mail_send_to',
                    'mail_enabled'
                    ]
    list_display_links = list_display
    fieldsets = [
                ('WatchMan - Send mail  - info', {'fields': ['mail_user_id',
                                                             'mail_name',
                                                             ]
                                                  }
                 ),
                ('Get value form device', {'fields': ['mail_data_from_sensor',
                                                      'mail_range_acc'
                                                      ]
                                           }
                 ),
                ('Conditions min / max ', {'fields': ['mail_condition_min_e',
                                                      'mail_condition_min',
                                                      'mail_condition_max_e',
                                                      'mail_condition_max'
                                                      ]
                ...
                ('Mail Settings', {'fields': ['mail_data',
                                              'mail_send_to'
                                              ]
                                   }
                 ),
                ('Mail subject and content', {'fields': ['mail_subject',
                                                         'mail_mesge_if_min',
                                                         'mail_mesge_if_max'
                                                         ]
                                              }
...
class PortListenerModelAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
                ...
                ('Start / stop commands ', {'fields': ['pl_command_start',
                                                       'pl_command_stop'
                                                       ]
                                            }
                 ),
...
class CommandLineAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
                ('Exec Linux Command - info', {'fields': ['cmd_user_id',
                                                          'cmd_name',
                                                          'cmd_describe'
                                                          ]
                                               }),
                ...
                ('Where To Execute And Status ', {'fields': ['cmd_location',
                                                             'cmd_enabled'
                                                             ]
                                                 }
                 ),
...
class CronModelAdmin(admin.ModelAdmin):
    ...
    list_display_links = list_display
    fieldsets = [('Settings - Linux Cron Table', {'fields': ['cron_comment',
                                                             'cron_last_exec_date',
                                                             'cron_last_file_exec'
                                                             ]
                                                  }
                  ),
                 ('Cron Interval - 1 every: run on each minute./hour/day, 1 on: run only in this min./hour/day',{
                                                              'fields': ['cron_minute_id',
                                                                         'cron_minute_on_every_id',
                 ...
                 ('Execute command', {'fields': ['cron_interpreter',
                                                 'cron_file_path'
                                                 ]
                                      }
                  ),
                 ('Where To Execute And Status ', {'fields': ['cron_where_exec',
                                                              'cron_enabled'
                                                              ]
                                                   }
                  ),
...
class GroupsAdmin(admin.ModelAdmin):
    ...
    list_display_links = list_display
    fieldsets = [
                ('Settings - Sensors Groups - info', {'fields': ['group_user_id',
                                                                 'group_name', 
                                                                 ]
                                                      }
                 ),
...
class UnitAdmin(admin.ModelAdmin):
    ...
    list_display_links = list_display
    fieldsets = [
                ('Settings - Sensors Units  - info', {'fields': ['unit_user_id',
                                                                 'unit_name',
                                                                 'unit_sign'
                                                                 ]
                                                      }
...
class MailingListAdmin(admin.ModelAdmin):
    ...
    list_display_links = list_display
    fieldsets = [
                ('Settings - Emails accounts list  - info', {'fields': ['ml_user_id',
                                                                        'ml_name',
                                                                        ]
                                                             }
                 ),
                ('Email data ', {'fields': ['ml_user',
                                            'ml_password',
                                            'ml_smtp',
                                            'ml_port'
                                            ]
...
class BusTypesAdmin(admin.ModelAdmin):
    ...
    list_display_links = list_display
    fieldsets = [('Settings - Bus Types - info', {'fields': ['bus_name',
                                                             'bus_description'
                                                             ]
                                                  }
                  ),
...
class SwitchModelAdmin(admin.ModelAdmin):
    ...
    list_display_links = list_display
    fieldsets = [
                ('WatchMan - Switch - info', {'fields': ['switch_user_id',
                                                         'switch_name',
                                                         'switch_descript',
                                                         'switch_data_from_sens',
                                                         'switch_range_acc'
                                                         ]
                                              }
                 ),
                ('Switch at min value ', {'fields': ['switch_value_min_e',
                                                     'switch_reference_sensor_min_e',
                                                     'switch_reference_sensor_min',
                                                     'switch_value_min'
                                                     ]
                                          }
                 ),
                ('Switch at max value ', {'fields': ['switch_value_max_e',
                                                     'switch_reference_sensor_max_e',
                                                     'switch_reference_sensor_max',
                                                     'switch_value_max'
                                                     ]
                                          }
                 ),
...
class LocationsAdmin(admin.ModelAdmin):
    ...
    list_display = ['location_user_id',
                    'location_name',
                    'location_enabled'
                    ]
    list_display_links = list_display
    fieldsets = [
                ('Settings - Sensors Locations - info', {'fields': ['location_user_id',
                                                                    'location_name',
                                                                    ]
                                                         }
                 ),
...
class MainScreenAdmin(admin.ModelAdmin):
    ...
    list_display = ['dev_on_main_id',
                    'dev_on_main_name',
                    'dev_on_main_enabled',
                    ]
    list_display_links = list_display
    fieldsets = [
                ('Settings - Sensors on Main screen - info', {'fields': ['dev_on_main_id',
                                                                         'dev_on_main_name'
                                                                         ]
                                                              }
                 ),
                ...
                ('devices on Main screen', {'fields': ['dev_on_main_screen_1',
...
class MathModelAdmin(admin.ModelAdmin):
    ...
    list_display_links = list_display
    fieldsets = [
                ('Exec - Mathematical Expresions - info', {'fields': ['math_user_id',
                                                                      'math_name',
                                                                      'math_descript'
                                                                      ]
                                                           }
                 ),
                ('Get data from devices 1', {'fields': ['math_data_from_1',
                                                        'math_data_from_1_count',
                                                        'math_data_from_1_date'
                                                        ]
                                             }
                 ),
                ('Get data from devices 2', {'fields': ['math_data_from_2',
                                                        'math_data_from_2_count',
                                                        'math_data_from_2_date',
                                                        ]
                                             }
                 ),
                ('Get data from devices 3', {'fields': ['math_data_from_3',
                                                        'math_data_from_3_count',
                                                        'math_data_from_3_date',
                                                        ]
                                             }
                 ),
                ('Get data from devices 4', {'fields': ['math_data_from_4',
                ...
                # ('Exec expression when condition is true', {'fields': ['math_exec_if_cond_e',
                #                                                          'math_exec_cond',
                #                                                          'math_exec_cond_value_min_e',
                #                                                          'math_exec_cond_value_min',
                #                                                          'math_exec_cond_value_max_e',
                #                                                          'math_exec_cond_value_max',
                #                                                          'math_exec_cond_force_value_e',
                #                                                          'math_exec_cond_force_value'
                #                                                          ]
                #                                                }
                #  ),
